...
public class ChattingAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            view = LayoutInflater.from(context).inflate(R.layout.item_chat_list, null);
...
//            holder.receiveHeader.setImageResource(isPatientApp ? R.drawable.icon_header_default_patient : R.drawable.icon_header_default);
            ...
            if (!list.get(i).getGuestProfilePicId().isEmpty()) {
                ...
                ImageLoaderUtil.getInstance().loadImage(imageLoader, url, holder.receiveHeader, getOptions());
            }
...
//        return false;
    ...
    public DisplayImageOptions getOptions() {
        DisplayImageOptions options = new DisplayImageOptions.Builder().
                ...
                cacheOnDisk(true).
                imageScaleType(ImageScaleType.IN_SAMPLE_POWER_OF_2).
                showImageOnLoading(R.drawable.icon_header_default).
                build();
        return options;
    }
