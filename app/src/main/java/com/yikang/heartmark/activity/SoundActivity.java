...
import com.yikang.heartmark.xunfei.ApkInstaller;
import com.yikang.heartmark.xunfei.TtsSettings;
...
public class SoundActivity extends Activity implements OnClickListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mInstaller = new  ApkInstaller(SoundActivity.this);
	}
	...
	public void onClick(View view) {
		...
		case R.id.image_tts_set:
			if(SpeechConstant.TYPE_CLOUD.equals(mEngineType)){
				Intent intent = new Intent(SoundActivity.this, TtsSettings.class);
