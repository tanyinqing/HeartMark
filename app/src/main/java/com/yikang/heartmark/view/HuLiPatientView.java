...
public class HuLiPatientView extends LinearLayout implements
	...
	public HuLiPatientView(Context context) {
		super(context);
		this.context = context;
		LayoutInflater.from(context).inflate(R.layout.huli_patient_view, this,
				true);
		init();
	}

	public HuLiPatientView(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		LayoutInflater.from(context).inflate(R.layout.huli_patient_view, this,
				true);
	...
	private void init() {
		zixunListView = (DynamicListView) findViewById(R.id.huli_patient_listview);
		...
		ConnectionManager.getInstance().send("FN11050WL00",
				"queryPatientCareList", params, "patientSucessCallBack", this);
	...
	private OnItemClickListener itemClickListener = new OnItemClickListener() {
		public void onItemClick(AdapterView<?> parent, View view, int position,
			...
			detailIntent.putExtra("readtext", infoList.get(position - 1).contentRead);
	...
	public void patientSucessCallBack(Object data) {
	...
	public boolean onRefreshOrMore(DynamicListView dynamicListView,
		...
		if (isRefresh) {
			...
			ConnectionManager.getInstance()
					.send("FN11050WL00", "queryPatientCareList", params,
							"getMoreSucessCallBack", this);
		}
		return false;
	}
}
