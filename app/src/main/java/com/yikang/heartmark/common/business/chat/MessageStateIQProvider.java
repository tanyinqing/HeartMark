 ...
 */
public class MessageStateIQProvider implements IQProvider {
            ...
            switch (parser.next()) {
                ...
                case XmlPullParser.END_TAG:
                    ...
                    if ("query".equals(parser.getName())) {
                        return new MessageStateIQ("<query xmlns='http://kanebay.com/protocol/offlinemessage#exist'>"+buffer.toString().trim()+"</query>");
                    }else {
                        buffer.append("</" + parser.getName() + '>');
                    }
                    break;
